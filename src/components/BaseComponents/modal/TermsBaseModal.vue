<template>
  ...
  <dialog open>
    ...
    <p>Global Trade Express LTD ("Website"), which includes all products and services offered by Global Trade Express LTD,
      is and remains the sole property of the Company. All rights are reserved in and for the Company Global Trade Express LTD
      group is the owner of all the intellectual property rights, including trade names, trademarks, logos
      and the trade names in and are exclusive to Global Trade Express LTD at all times. Except where expressly stated
      ...
      any materials or media from the Website, without obtaining prior written permission from Global Trade Express LTD
      Group.</p>
    </div>
    <div>
      <h3>Data</h3>
    ...
    <div>
      <h3>Amendments</h3>
      <p>Income Plus Limited has the right to amend the Agreement without obtaining any prior consent from the Client.
