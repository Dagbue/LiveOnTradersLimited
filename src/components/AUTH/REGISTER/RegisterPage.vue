  ...
  <form class="signUp" @submit.prevent="handleSubmit">
    <div class="wrapper">
      <div class="headline">
        ...
        <h2>
          Create New
          <span class="header-span"> Live On Traders </span> Limited Account
        </h2>
        <p>
      ...
      <div class="form">
        <div class="signUp">
          ...
          <div class="form-group">
<!--            <input type="text" placeholder="Country" required="" name="Country" v-model="country" />-->
          ...
          <div class="form-group-3">
            <p class="form-group-3-para">Identification Card (Upload ID card for verification)</p>
          ...
          <div class="form-group-2">
            ...
            <label for="remember-me" class="checkbox-text"
              >I Agree To Live On Traders Limited
              <a @click="showDialog" class="terms">Terms And Condition</a></label
            >
          </div>
