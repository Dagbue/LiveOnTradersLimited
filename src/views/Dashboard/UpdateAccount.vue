  ...
  <base-modal4  @close="hideDialog" v-if="dialogIsVisible" class="subscribe">
    ...
    <form @submit.prevent="sendDeposit">
      ...
      <div class="five">
        ...
        <input type="text" placeholder="" required=""   class="full-name" v-model="phoneNumber"/>
      </div>
      <div class="five">
        <label class="account">Date Of Birth:</label>
        <input type="datetime-local" placeholder="" required=""   class="full-name" v-model="dateOfBirth" />
      </div>
