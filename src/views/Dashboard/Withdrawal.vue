    ...
    <form @submit.prevent="sendWithdrawl" v-show="deposit">
      <div class="bank-trans">
        <div class="bank-trans-form">
          ...
          <input type="text" placeholder="Enter Amount" required name="amount" v-model="withdrawal" />
        </div>
      ...
      <base-modal3 @close="hideDialog" v-if="dialogIsVisible">
        ...
        <p class="modal-text-2">Kindly Note:For Faster Response you can contact support at <span>  <a href="mailto:support@globaltradeexpresslimited.com" class="para-last">support@globaltradeexpresslimited.com</a></span></p>
        <div class="bank-trans-form2">
        </div>
